...
$valid['messages'] = "You have successfully edited health info in the system.";
...
<div class="text-center">
    <h1 class="text-light">Add Info</h1>
</div>
<div class="messages">
							<?php if($valid) {
...
<div class="col-6">
  ...
  <div class="col-6">
    ...
    <input type="text"  class="form-control" name="days" value="<?php echo $row['collectionperiod'];?>" id="inputAddress2" placeholder="Surname">
  </div>
  <div class="col-12">
  <br>
