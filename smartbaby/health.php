...
?>
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Health tips</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                <tbody>
                                <?php
                                $sql4 = "SELECT * FROM tips WHERE course = $course ORDER by date DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                        <?php  echo $row4['tip'];?></td>
                                        <td><a href='tip.php?i=<?php echo $row4['id'];?>'><button type="button" class="btn btn-outline-primary">View</button></a></td>
                                    </tr>
                                  <?php
                                }
                                  ?>
